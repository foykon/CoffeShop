...
public class IQKKPSPublicSoap
{
    ...
    public IQKKPSPublicSoap(){}

    public IQKKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IQKKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IQKExtendedSoapSerializationEnvelope envelope= new IQKExtendedSoapSerializationEnvelope(IQKExtendedSoapSerializationEnvelope.VER11);
